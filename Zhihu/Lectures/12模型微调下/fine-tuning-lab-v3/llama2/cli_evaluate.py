        ...
        for data in tqdm(test_data):
            ...
            with torch.no_grad():
                outputs = self.model.generate(
                    **inputs, max_length=3073, num_beams=1, do_sample=False
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", type=str, default=None, required=True, help="main model weights"
    )
    parser.add_argument(
        "--ckpt", type=str, default=None, required=True, help="The checkpoint path"
    )
    parser.add_argument(
        "--data", type=str, default=None, required=True, help="The dataset file path"
    )

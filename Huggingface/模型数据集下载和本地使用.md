...
```shell
huggingface-cli download --resume-download --repo-type dataset --local-dir-use-symlinks False teknium/OpenHermes-2.5 --local-dir /Users/lin/Documents/models/model_directory/OpenHermes
```
